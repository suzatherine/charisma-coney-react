...
const useBackgroundAudio = ({ disabled  } = {})=>{
    const [backgroundAudio, setBackgroundAudio] = useState();
    const [backgroundAudioIdle, setBackgroundAudioIdle] = useState();
    const backgroundAudioIdleSrc = useRef();
    ...
    const onMessage = useCallback(async (messageEvent)=>{
        if (messageEvent.type === "character" || messageEvent.type === "panel") {
            ...
            if (newBackgroundAudio === undefined && newBackgroundAudioIdle === undefined) {
            ...
            const newBackgroundAudioBlobPromise = newBackgroundAudio !== undefined && newBackgroundAudio !== "false" ? fetchMedia(newBackgroundAudio) : undefined;
            const newBackgroundAudioIdleBlobPromise = newBackgroundAudioIdle !== undefined && newBackgroundAudioIdle !== "false" ? fetchMedia(newBackgroundAudioIdle) : undefined;
            ...
            if (newBackgroundAudioIdle !== undefined && newBackgroundAudioIdle !== "false" && newBackgroundAudioIdle !== backgroundAudioIdleSrc.current) {
                // Wait for it to load...
                ...
                if (audioRef.current) {
                    ...
                    if (audioRef.current.ended || newBackgroundAudio === undefined || newBackgroundAudio === "false") {
                        setIsAudioIdleActive(true);
                    }
                    audioRef.current.play();
                }
            } else if (newBackgroundAudioIdle === undefined || newBackgroundAudioIdle === "false") {
